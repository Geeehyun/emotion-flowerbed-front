<template>
  <div v-if="modelValue" class="teacher-modal-overlay" @click="handleClose">
    <div class="teacher-modal-content teacher-risk-history-modal" @click.stop>
      <div class="teacher-modal-header">
        <div>
          <h3 class="teacher-modal-title">{{ studentName }} 학생</h3>
          <p class="teacher-modal-subtitle">위험도 변화 이력</p>
        </div>
